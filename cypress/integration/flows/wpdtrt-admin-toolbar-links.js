/**
 * @file DTRT Admin Toolbar Links wpdtrt-admin-toolbar-links.js
 * @summary
...
describe("Test Name", function () {
  ...
  describe("Setup", function () {
    it("Has prerequisites", function () {
      ...
      cy.window().should("have.property", "wpdtrt_admin_toolbar_links_ui")

      // check that it's an object
      cy.window().then((win) => {
        expect(win.wpdtrt_admin_toolbar_links_ui).to.be.a("object");
      });
    });
  });
